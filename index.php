          ...
          <nav class="header-nav burger-menu">
            <ul class="header-list offset-xl-7 col-xl-5">
              ...
              <li class="header-list__item">
                ...
                <button class="header-list__lang" onclick="window.location.href = './index-ru.html'">RU</button>
              </li>
            </ul>
              ...
              <div class="row popup__content">
                ...
                <div class="header-main__btn popup-btn">
                  <a href="#contact_us" class="header-main__link popup-link popup-link__form">Sign up for a free
                    session</a>
                  <!-- <a href="#contact_us" class="header-main__link popup-link popup-link__form close">Sign up for a free session</a> -->
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-xl-6 col-12 about-items">
            ...
            <p class="about-text">
              ...
              fusion
              of yoga and fitness as a catalyst for personal transformation. <br>
              Namaste!
            </p>
